pub fn invoke_handler() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        super::chat_commands::get_chat_payload_raw,
        super::chat_commands::get_chat_payload_path,
        super::chat_commands::get_chat_payload_text,
        super::chat_commands::save_chat_payload_raw,
        super::chat_commands::save_chat_payload_from_file,
        super::chat_commands::get_group_chat,
        super::chat_commands::get_group_chat_raw,
        super::chat_commands::get_group_chat_path,
        super::chat_commands::get_group_chat_text,
        super::chat_commands::save_group_chat,
        super::chat_commands::save_group_chat_raw,
        ...
        super::data_archive_commands::read_data_archive_file,
