...
- `api.agent`（已落地 Phase 2D canonical model IR、上下文只读工具与 workspace 读改工具循环）
...
- Agent 已落地当前 Host ABI、Phase 2D canonical model IR、上下文只读工具与 workspace 读改工具；真实边界见 `docs/API/Agent.md` 与 `docs/CurrentState/AgentFramework.md`
