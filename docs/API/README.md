...
- `api.mcp`（M2.1 已落地）
  ...
  - 当前提供 Active/Paused、Off/Ask/Allow、显式 refresh、完整分页、diagnostics 与 typed one-shot call outcome；尚无 Agent/Legacy model exposure。
...
| [MCP.md](MCP.md) | `api.mcp` M2.1 当前参考（registration/persistent catalog/user test call） |
...
- MCP M2.1 当前边界见 `docs/API/MCP.md` 与 `docs/CurrentState/MCP.md`
