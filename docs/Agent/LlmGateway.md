...
- observed route 支持 OpenAI、OpenRouter、Custom、DeepSeek、Groq、Moonshot、NanoGPT、Chutes、SiliconFlow、Workers AI、Z.AI 与 MiniMax 的 `/chat/completions`，以及 Custom OpenAI Responses `/responses`；其它 route 明确失败。
