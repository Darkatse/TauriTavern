...
截至 2026-04-29，Phase 2C 上下文只读工具、workspace 读改工具循环与前端 dryRun adapter 已落地。当前真实能力边界以 `docs/CurrentState/AgentFramework.md` 为准；本目录中的 profile、MCP、timeline、diff/rollback 等内容仍是后续设计。
