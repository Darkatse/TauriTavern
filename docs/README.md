...
- Agent 系统已落地 Phase 2C 上下文只读工具、workspace 读改工具循环与前端 dryRun adapter。当前事实见 `docs/CurrentState/AgentFramework.md`；高层文档放在 `docs/AgentArchitecture.md` / `docs/AgentContract.md` / `docs/AgentImplementPlan.md`，细节文档放在 `docs/Agent/`
