...
- Agent 系统已完成 Phase 0/1，并已落地 Phase 2A 最小工具循环与前端 dryRun adapter。高层文档放在 `docs/AgentArchitecture.md` / `docs/AgentContract.md` / `docs/AgentImplementPlan.md`，细节文档放在 `docs/Agent/`
