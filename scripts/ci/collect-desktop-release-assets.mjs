...
// Desktop-only variant of collect-release-assets.mjs: it validates the full
// desktop bundle set without requiring the mobile (android/ios) artifacts that
// the full-release collector expects.
