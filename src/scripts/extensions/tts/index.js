...
/**
 * Clones a message, attaches the chat message ID, then splits by paragraphs
 ...
 * @param {boolean} [options.manual=false] - Whether this TTS job was manually triggered.
 * @returns {void}
 */
...
async function tts(text, voiceId, char, voiceMapKey = null) {
    ...
    async function processResponse(response) {
        ...
        await eventSource.emit(event_types.TTS_AUDIO_READY, {
            messageId,
            characterName: char,
            text,
